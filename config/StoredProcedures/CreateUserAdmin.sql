...
IF @unique<=0 THEN
	INSERT INTO Users (Username, FirstName, LastName, Email, PermsID, HP, US, DateCreated) VALUES(_Username,_FirstName,_LastName,_Email,_PermsID,_HP,_US,_DateCreated);
ELSE
